...
package com.minivision.feign.extend.converter;
...
import static com.minivision.feign.extend.util.CharsetUtil.UTF_8;
...
public class SpringManyMultipartFilesReader extends AbstractHttpMessageConverter<MultipartFile[]> {
    ...
    protected boolean canWrite(MediaType mediaType) {
        // Class NOT meant for writing multipart/form-data HTTP bodies
        return false;
    }
    ...
    private byte[] getMultiPartBoundary(MediaType contentType) {
        ...
        if (boundaryString == null || StringUtils.isEmpty(boundaryString)) {
