...
import com.minivision.feign.extend.form.writer.ByteArrayWriter;
import com.minivision.feign.extend.form.writer.DelegateWriter;
import com.minivision.feign.extend.form.writer.FormDataWriter;
import com.minivision.feign.extend.form.writer.ManyFilesWriter;
import com.minivision.feign.extend.form.writer.ManyParametersWriter;
import com.minivision.feign.extend.form.writer.Output;
import com.minivision.feign.extend.form.writer.PojoWriter;
import com.minivision.feign.extend.form.writer.SingleFileWriter;
import com.minivision.feign.extend.form.writer.SingleParameterWriter;
import com.minivision.feign.extend.form.writer.Writer;
...
import static com.minivision.feign.extend.form.ContentType.MULTIPART;
import static com.minivision.feign.extend.util.HttpFormConstants.*;
    ...
    public void process(RequestTemplate template, Charset charset, Map<String, Object> data) {
        ...
        try (val output = new Output(charset)) {
            ...
            val contentTypeHeaderValue = new StringBuilder()
                    ...
                    .toString();
            // reset header
            template.header(CONTENT_TYPE_HEADER, Collections.<String>emptyList());
            ...
            throw new EncodeException("process encoding error", e);
        }
    }
